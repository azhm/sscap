...
void CBitmapEx::_RotateNearestNeighbour(long degrees, _PIXEL bgColor)
{
	...
	if (IsValid())
	{
		...
		long _width = (long)(abs((long)(m_bih.biWidth*cos(_angle))) + abs((long)(m_bih.biHeight*sin(_angle))) + 0.5f);
		long _height = (long)(abs((long)(m_bih.biWidth*sin(_angle))) + abs((long)(m_bih.biHeight*cos(_angle))) + 0.5f);
		long _pitch = m_iBpp * _width;
		while ((_pitch & 3) != 0)
			_pitch++;
